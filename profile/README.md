...
|---|---|---|
| [openrz67-trigger](https://github.com/openrz67/openrz67-trigger) | ESP32-C3 Bluetooth remote release: firmware, KiCad PCB, enclosure | Rev 2 designed, not yet fabricated |
| [openrz67-android](https://github.com/openrz67/openrz67-android) | Android app: shutter, bulb, countdown over BLE | v1.0 released |
